package com.dandy.module.android.imageloader;
...
import com.dandy.module.android.imageloader.ImageSizeUtil.ImageSize;
 ...
 * 调用
 * mImageLoader.loadImage(path, imageView, mOptions);//path为网络地址或本地地址
 * </pre>
 */
public class ImageLoader {
    ...
    private void refreashBitmap(String path, ImageView imageView, Bitmap bm, DisplayImageOptions options) {
